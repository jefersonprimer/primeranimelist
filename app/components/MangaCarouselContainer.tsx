...
export function MangaCarouselContainer({
  children,
}: MangaCarouselContainerProps) {
      ...
      {canScrollRight && (
        ...
        >
          <button
            ...
            className="hidden md:flex pointer-events-auto mr-2 h-14 w-14 items-center justify-center border-[3px] border-zinc-900 bg-white text-zinc-900 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all -translate-y-6 hover:bg-zinc-100 active:shadow-none active:translate-x-1 active:translate-y-1 dark:border-white dark:bg-zinc-900 dark:text-white dark:shadow-[6px_6px_0px_0px_rgba(255,255,255,1)]"
