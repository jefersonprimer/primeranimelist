    ...
    <div className="group relative w-full">
      ...
      {canScrollLeft && (
        <button
          ...
          className="absolute left-0 top-0 z-30 h-full hidden md:flex items-center justify-center text-zinc-400 transition-all hover:text-[#f2f2f2] hover:cursor-pointer bg-transparent hover:bg-black/20"
      ...
      {canScrollRight && (
        <button
          ...
          style={{ width: dynamicPadding }}
          className="absolute right-0 top-0 z-30 h-full hidden md:flex items-center justify-center text-zinc-400 transition-all hover:text-[#f2f2f2] hover:cursor-pointer bg-transparent hover:bg-black/20"
