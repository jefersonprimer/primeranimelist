...
const UserProfileButton: React.FC<UserProfileButtonProps> = ({ isDark }) => {
  ...
  if (isLoading) {
    return (
      <div
        className={`px-4 py-[21px] lg:py-[10px] ${isDark ? "text-white" : "text-[#4A4E62]"}`}
      >
        ...
        >
          {userProfile ? (
            <>
              ...
              <div
                className={`px-4 py-3 ${isDark ? "hover:bg-[#4A4E58]" : "hover:bg-[#E6E5E3]"}`}
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full overflow-hidden">
                    <Image
                      src={
                        userProfile.profile_image_url || "/default-avatar.png"
                      }
                      alt="User profile"
                      width={40}
                      height={40}
                  ...
                  <div>
                    <h3
                      className={`text-lg font-medium ${isDark ? "text-white" : "text-[#000000]"}`}
                    >
                ...
                <ul>
                  <li className="flex items-center justify-center">
                    ...
                    >
                      ...
                      >
                        <path
                          d="M11.7733 5.76876L12.1951 6.37871L12.9012 6.15222L16.5297 4.98844L14.5439 12H3.45612L1.47001 4.98733L5.10881 6.15238L5.8156 6.37867L6.23694 5.76774L9.00109 1.75978L11.7733 5.76876Z"
                          stroke="black"
                          strokeWidth="2"
                        ></path>
                      </svg>
                  ...
                  <li className="hover:bg-[#4A4E58] py-4 px-8">
                    <a href="/watchlist" className="flex items-center gap-2">
                      <div className="w-5 h-5">
                        ...
                        >
                          <path
                            d="M12 16.11L8.74 13.78C8.23 13.42 7.62 13.22 7 13.22C6.37 13.22 5.77 13.41 5.26 13.78L2 16.11V2H12V16.11ZM13 0H1C0.45 0 0 0.45 0 1V18.06C0 18.27 0.07 18.47 0.19 18.64C0.51 19.09 1.13 19.2 1.58 18.88L6.42 15.43C6.77 15.18 7.23 15.18 7.58 15.43L12.42 18.88C12.87 19.2 13.49 19.1 13.81 18.65C13.93 18.48 14 18.28 14 18.07V1C14 0.45 13.55 0 13 0Z"
                            fill="#A0A0A0"
                          ></path>
                        </svg>
                      </div>
                      ...
                      <div className="w-5 h-5">
                        ...
                        >
                          <g clipPath="url(#clip0_1921_74073)">
                            <path
                              d="M20 12V14H4V12H20ZM1 12C1.55 12 2 12.45 2 13C2 13.55 1.55 14 1 14C0.45 14 0 13.55 0 13C0 12.45 0.45 12 1 12ZM20 6V8H4V6H20ZM1 6C1.55 6 2 6.45 2 7C2 7.55 1.55 8 1 8C0.45 8 0 7.55 0 7C0 6.45 0.45 6 1 6ZM20 0V2H4V0H20ZM1 0C1.55 0 2 0.45 2 1C2 1.55 1.55 2 1 2C0.45 2 0 1.55 0 1C0 0.45 0.45 0 1 0Z"
                              fill="#A0A0A0"
                            ></path>
                          </g>
                          <defs>
            ...
            <>
              ...
              >
                <a
                  href="https://sso.crunchyroll.com/authorize?client_id=opy75pstrnzw4edkr9ed&redirect_uri=https%3A%2F%2Fwww.crunchyroll.com%2Fcallback&response_type=cookie&state=%2Faccount%2Fpreferences&prompt=register"
                  className="block"
                >
                  <h3
                    className={`text-xl ${isDark ? "text-white" : "text-[#000000]"}`}
                  >
                    Criar Conta
                  </h3>
                  <p
                    className={`${isDark ? "text-[#A0A0A0]" : "text-[#4A4E58]"} text-sm mt-1`}
                  >
                    Cadastre-se de graça ou torne-se Premium.
                  </p>
                </a>
              </div>
              ...
              >
                <a
                  href="https://sso.crunchyroll.com/authorize?client_id=opy75pstrnzw4edkr9ed&redirect_uri=https%3A%2F%2Fwww.crunchyroll.com%2Fcallback&response_type=cookie&state=%2Fpt-br%2Fnews%3Fsrsltid%3DAfmBOoqMk22pd8F4V5UHEkB9feOxBsrINMqZK6wMDqHw4VwDFIKdYqaj"
                  className="block"
                >
                  <h3
                    className={`text-xl ${isDark ? "text-white" : "text-[#000000]"}`}
                  ...
                  <p
                    className={`${isDark ? "text-[#A0A0A0]" : "text-[#4A4E58]"} text-sm mt-1`}
                  >
                    Já é membro da Crunchyroll? Seja bem-vindo.
                  </p>
                </a>
              </div>
